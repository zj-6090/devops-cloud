...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.btlab.devops";
    private static final String ARTIFACT_ID = "btlab";
    private static final String PACKAGE_NAME = "com.btlab.devops";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.btlab.devops";
        String artifactIdNew = "btlab";
        String packageNameNew = "com.btlab.devops";
        String titleNew = "土豆管理系统";
        String projectBaseDirNew = "F:\\云Gitee\\BTLAB\\devops\\devops-cloud"; // 一键改名后，“新”项目所在的目录
