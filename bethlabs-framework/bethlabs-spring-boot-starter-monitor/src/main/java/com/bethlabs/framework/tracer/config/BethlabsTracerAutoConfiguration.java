package com.bethlabs.framework.tracer.config;

import com.bethlabs.framework.common.enums.WebFilterOrderEnum;
import com.bethlabs.framework.tracer.core.aop.BizTraceAspect;
import com.bethlabs.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "bethlabs.tracer", value = "enable", matchIfMissing = true)
public class BethlabsTracerAutoConfiguration {
