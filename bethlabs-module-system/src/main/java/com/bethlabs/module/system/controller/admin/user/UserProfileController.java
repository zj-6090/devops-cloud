package com.bethlabs.module.system.controller.admin.user;
...
import com.bethlabs.module.system.convert.user.UserConvert;
...
public class UserProfileController {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免只查看自己时，查询不到分组。
