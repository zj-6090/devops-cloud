package com.bethlabs.module.system.service.social;
...
import com.bethlabs.framework.common.util.cache.CacheUtils;
import com.bethlabs.framework.common.util.http.HttpUtils;
import com.bethlabs.framework.common.util.object.BeanUtils;
import com.bethlabs.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.bethlabs.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.bethlabs.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.bethlabs.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.bethlabs.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.bethlabs.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.bethlabs.module.system.dal.dataobject.social.SocialClientDO;
import com.bethlabs.module.system.dal.mysql.social.SocialClientMapper;
import com.bethlabs.module.system.dal.redis.RedisKeyConstants;
import com.bethlabs.module.system.enums.social.SocialTypeEnum;
import com.bethlabs.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.bethlabs.framework.common.util.collection.MapUtils.findAndThen;
import static com.bethlabs.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.bethlabs.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${bethlabs.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${bethlabs.wxa-subscribe-message.miniprogram-state:formal}")
