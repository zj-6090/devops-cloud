...
import com.bethlabs.module.system.controller.admin.permission.vo.role.RolePageReqVO;
...
import com.bethlabs.module.system.dal.mysql.permission.RoleMapper;
...
public class RoleServiceImpl implements RoleService {
    ...
    public Long createRole(RoleSaveReqVO createReqVO, Integer type) {
        ...
        RoleDO role = BeanUtils.toBean(createReqVO, RoleDO.class)
                ...
                .setDataScope(DataScopeEnum.DATASCOPE_ALL.getScope()); // 默认可查看所有数据。原因是，可能一些项目不需要项目权限
    ...
    public void updateRoleDataScope(Long id,
                                     Integer dataScope,
        ...
        updateObject.setDataScopeProjectIds(dataScopeProjectIds);
