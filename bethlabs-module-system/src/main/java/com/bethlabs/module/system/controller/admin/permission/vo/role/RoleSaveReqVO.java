...
import com.bethlabs.framework.common.validation.InEnum;
...
public class RoleSaveReqVO {
    ...
    @Schema(description = "系统类型（1：管理端 2：运维端 3：IDS端 4：维修端）", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "系统类型不能为空")
    @DiffLogField(name = "系统类型")
    private Integer systemType;

    @Schema(description = "js定位概图文件名称", example = "overview.js")
    @DiffLogField(name = "js定位概图文件名称")
