package com.bethlabs.module.system.controller.admin.dict;
...
import com.bethlabs.module.system.controller.admin.dict.vo.data.DictDataPageReqVO;
import com.bethlabs.module.system.controller.admin.dict.vo.data.DictDataRespVO;
import com.bethlabs.module.system.controller.admin.dict.vo.data.DictDataSaveReqVO;
import com.bethlabs.module.system.controller.admin.dict.vo.data.DictDataSimpleRespVO;
...
public class DictDataController {
    ...
    @GetMapping("/getAllByDictType")
    @Operation(summary = "获取该类型下所有字典数据")
    @PermitAll
    public CommonResult<PageResult<DictDataRespVO>> getAllByDictType(DictDataPageReqVO pageReqVO) {
