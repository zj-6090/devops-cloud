package com.bethlabs.module.system.controller.admin.permission.vo.role;
...
public class RoleRespVO {
    ...
    @Schema(description = "数据范围(指定分组数组)", example = "1")
    private Set<Long> dataScopeDeptIds;

    @Schema(description = "创建时间", requiredMode = Schema.RequiredMode.REQUIRED, example = "时间戳格式")
    private LocalDateTime createTime;

    @Schema(description = "系统类型", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    private Integer systemType;

    @Schema(description = "js定位概图文件名称", example = "overview.js")
