package com.btlab.devops.module.infra.service.codegen.inner;
...
import com.btlab.devops.framework.apilog.core.enums.OperateTypeEnum;
...
import com.btlab.devops.framework.common.util.date.LocalDateTimeUtils;
import com.btlab.devops.framework.common.util.object.BeanUtils;
import com.btlab.devops.framework.common.util.object.ObjectUtils;
import com.btlab.devops.framework.common.util.string.StrUtils;
import com.btlab.devops.framework.excel.core.annotations.DictFormat;
import com.btlab.devops.framework.excel.core.convert.DictConvert;
import com.btlab.devops.framework.excel.core.util.ExcelUtils;
import com.btlab.devops.framework.mybatis.core.dataobject.BaseDO;
...
import com.btlab.devops.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.btlab.devops.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.btlab.devops.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.btlab.devops.module.infra.enums.codegen.CodegenSceneEnum;
import com.btlab.devops.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.btlab.devops.module.infra.enums.codegen.CodegenVOTypeEnum;
import com.btlab.devops.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    /**
     * 是否为 btlab-cloud 项目，用于解决 Boot 和 Cloud 的 api 模块兼容性问题
     *
     * true  - 需要有 btlab-module-xxx-api 模块
    ...
    public CodegenEngine() {
        ...
        this.cloudEnable = ClassUtils.isPresent("com.btlab.devops.module.infra.framework.rpc.config.RpcConfiguration",
    ...
    private Map<String, String> getTemplates(Integer frontType) {
        ...
        if (Boolean.FALSE.equals(cloudEnable)) {
            SERVER_TEMPLATES.forEach((templatePath, filePath) -> {
                filePath = StrUtil.replace(filePath, "/btlab-module-${table.moduleName}-api", "");
                filePath = StrUtil.replace(filePath, "/btlab-module-${table.moduleName}-server", "");
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "btlab-module-${table.moduleName}/" + // 顶级模块
                "btlab-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "btlab-module-${table.moduleName}/" + // 顶级模块
                "btlab-module-${table.moduleName}-server/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "btlab-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "btlab-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
