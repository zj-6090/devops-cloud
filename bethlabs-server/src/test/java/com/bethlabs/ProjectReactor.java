...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.bethlabs";
    private static final String ARTIFACT_ID = "bethlabs";
    private static final String PACKAGE_NAME = "com.bethlabs";
    private static final String TITLE = "智慧运维综合监管系统 V4.0.0";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.bethlabs";
        String artifactIdNew = "bethlabs";
        String packageNameNew = "com.bethlabs";
        String titleNew = "智慧运维综合监管系统 V4.0.0";
