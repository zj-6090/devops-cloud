package com.btlab.devops.module.system.service.social;
...
import com.btlab.devops.framework.common.util.cache.CacheUtils;
import com.btlab.devops.framework.common.util.http.HttpUtils;
import com.btlab.devops.framework.common.util.object.BeanUtils;
import com.btlab.devops.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.btlab.devops.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.btlab.devops.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.btlab.devops.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.btlab.devops.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.btlab.devops.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.btlab.devops.module.system.dal.dataobject.social.SocialClientDO;
import com.btlab.devops.module.system.dal.mysql.social.SocialClientMapper;
import com.btlab.devops.module.system.dal.redis.RedisKeyConstants;
import com.btlab.devops.module.system.enums.social.SocialTypeEnum;
import com.btlab.devops.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.btlab.devops.framework.common.util.collection.MapUtils.findAndThen;
import static com.btlab.devops.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.btlab.devops.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${btlab.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${btlab.wxa-subscribe-message.miniprogram-state:formal}")
