package com.btlab.devops.module.system.controller.admin.socail.vo.client;
...
import com.btlab.devops.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "btlab商城")
