 ...
 *      1）Spring Async：
 *          {@link com.btlab.devops.framework.quartz.config.BtlabAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 BtlabSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.btlab.devops.framework.tenant;
