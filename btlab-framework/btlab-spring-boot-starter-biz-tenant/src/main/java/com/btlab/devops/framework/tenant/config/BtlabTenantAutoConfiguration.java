...
import com.btlab.devops.framework.mybatis.core.util.MyBatisUtils;
import com.btlab.devops.framework.redis.config.BtlabCacheProperties;
import com.btlab.devops.framework.security.core.service.SecurityFrameworkService;
import com.btlab.devops.framework.tenant.core.aop.TenantIgnore;
import com.btlab.devops.framework.tenant.core.aop.TenantIgnoreAspect;
import com.btlab.devops.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.btlab.devops.framework.tenant.core.job.TenantJobAspect;
import com.btlab.devops.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.btlab.devops.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.btlab.devops.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.btlab.devops.framework.tenant.core.redis.TenantRedisCacheManager;
import com.btlab.devops.framework.tenant.core.security.TenantSecurityWebFilter;
import com.btlab.devops.framework.tenant.core.service.TenantFrameworkService;
import com.btlab.devops.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.btlab.devops.framework.tenant.core.web.TenantContextWebFilter;
import com.btlab.devops.framework.tenant.core.web.TenantVisitContextInterceptor;
import com.btlab.devops.framework.web.config.WebProperties;
import com.btlab.devops.framework.web.core.handler.GlobalExceptionHandler;
...
public class BtlabTenantAutoConfiguration {
    ...
    public TenantFrameworkService tenantFrameworkService(TenantCommonApi tenantApi) {
        // 参见 https://gitee.com/zhijiantianya/btlab-cloud/issues/IC6YZF
        try {
     ...
     */
    @Configuration
    @ConditionalOnClass(name = "com.btlab.devops.framework.mq.redis.core.RedisMQTemplate")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     BtlabCacheProperties btlabCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(btlabCacheProperties.getRedisScanBatchSize()));
