...
import com.btlab.devops.framework.tracer.core.aop.BizTraceAspect;
import com.btlab.devops.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "btlab.tracer", value = "enable", matchIfMissing = true)
public class BtlabTracerAutoConfiguration {
